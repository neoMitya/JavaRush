...
public class Solution {
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            printWriter.println(this.assets == null ? "null" : "not null");
            if(this.assets != null){
                printWriter.println(this.assets.size());

                for(int i = 0; i < this.assets.size(); i++){
                    printWriter.println(this.assets.get(i).getName());
                    printWriter.println(this.assets.get(i).getPrice());
                }
            }
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if(str.equals("not null")){
                ...
                for(int i = 0; i < count; i++){
                    ...
                    str = reader.readLine();
                    asset.setPrice(Double.parseDouble(str));
